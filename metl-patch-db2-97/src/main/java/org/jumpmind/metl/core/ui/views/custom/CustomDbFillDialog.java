...
public class CustomDbFillDialog extends ResizableWindow {
    ...
    public CustomDbFillDialog(IDatabasePlatform databasePlatform, CustomQueryPanel queryPanel) {
        this(databasePlatform, new HashSet<Table>(0), queryPanel);
    }

    public CustomDbFillDialog(IDatabasePlatform databasePlatform, Set<Table> selectedTableSet,
        ...
        fillButton = CommonUiUtils.createPrimaryButton("Fill...", new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                if (dbFill.getPrint() == false) {
                    ...
                    UI.getCurrent().removeWindow(CustomDbFillDialog.this);
                }
            }
        });
