 ...
 */
public class Db297DdlReader extends AbstractJdbcDdlReader {
    ...
    public Db297DdlReader(IDatabasePlatform platform) {
        super(platform);
    ...
    protected Table readTable(Connection connection, DatabaseMetaDataWrapper metaData,
        ...
        String tableName = (String) values.get("NAME");
    ...
    public List<Trigger> getTriggers(final String catalog, final String schema,
        ...
        String sql = "SELECT "
                ...
                + "LAST_REGEN_TIME as LAST_ALTERED "
        ...
        triggers = sqlTemplate.query(sql, new ISqlRowMapper<Trigger>() {
            public Trigger mapRow(Row row) {
                ...
                trigger.setEnabled(row.getString("VALID").equals("Y"));
                ...
                trigger.setTriggerType(Trigger.TriggerType.valueOf(trigEvent));
    ...
    protected Collection<Column> readColumns(DatabaseMetaDataWrapper metaData, String tableName)
        ...
        try {
            ...
            while (columnData.next()) {
                ...
                values.put("TABLE_NAME",tableName);
                values.put("COLUMN_NAME",values.get("NAME"));
