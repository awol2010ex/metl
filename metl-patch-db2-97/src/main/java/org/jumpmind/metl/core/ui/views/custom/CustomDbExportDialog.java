...
public class CustomDbExportDialog extends ResizableWindow {
    ...
    public CustomDbExportDialog(IDatabasePlatform databasePlatform, CustomQueryPanel queryPanel) {
        this(databasePlatform, new HashSet<Table>(), queryPanel);
    }

    public CustomDbExportDialog(IDatabasePlatform databasePlatform, Set<Table> selectedTableSet,
