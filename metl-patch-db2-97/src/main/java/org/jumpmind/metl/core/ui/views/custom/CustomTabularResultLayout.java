...
public class CustomTabularResultLayout extends VerticalLayout {
    ...
    CustomSqlRunner.ISqlRunnerListener listener;
    ...
    public CustomTabularResultLayout(CustomSqlExplorer explorer, IDb db, String sql, ResultSet rs, CustomSqlRunner.ISqlRunnerListener listener, String user, Settings settings, CustomQueryPanel queryPanel, boolean showSql, boolean isInQueryGeneralResults)
            throws SQLException {
    ...
    protected void createTabularResultLayout() {
        ...
        try {
            grid = putResultsInGrid(settings.getProperties().getInt(Settings.SQL_EXPLORER_MAX_RESULTS));
            grid.setSizeFull();
            ...
            int maxResultsSize = settings.getProperties().getInt(Settings.SQL_EXPLORER_MAX_RESULTS);
    ...
    protected CustomTabularResultLayout refreshWithoutSaveButton() {
    ...
    protected Grid putResultsInGrid(int maxResultSize) throws SQLException {
        ...
        return CommonUiUtils.putResultsInGrid(rs, resultTable, properties.getInt(Settings.SQL_EXPLORER_MAX_RESULTS), properties.is(Settings.SQL_EXPLORER_SHOW_ROW_NUMBERS),
                getColumnsToExclude());
